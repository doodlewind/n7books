	...
	<div class="navbar navbar-default navbar-fixed-top" role="navigation">
		<div class="container">
			<div class="navbar-header">
				...
				</button> <a class="navbar-brand" href="/i/books">南七书摊</a>
			</div>
			...
			<div class="navbar-collapse collapse">
				...
				<form class="navbar-form navbar-right" role="upload">
					<a href="/i/books/add" class="btn btn-primary" role="button"><span class="glyphicon glyphicon-plus"></span></a>
				</form>
				<ul class="nav navbar-nav navbar-right">
					...
					<li>
						<a href="/i/users/"><span class="glyphicon glyphicon-home"></span></a>
					</li>
				</ul>
