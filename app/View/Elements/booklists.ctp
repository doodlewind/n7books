...
<div class="col-xs-4">
	<select id="grade" name="data[Booklist][grade]" class="form-control">
...
<div class="col-xs-4">
	<select id="school" name="data[Booklist][school]" class="form-control">
...
<div class="col-xs-4">
	<select id="semester" name="data[Booklist][semester]" class="form-control">
