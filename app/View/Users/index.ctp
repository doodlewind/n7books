...
?>
					      ...
					      <div class="tab-pane fade col-xs-12" id="setting"><br>
								<div>
										<?php echo $this->Form->create('User',
											...
											<div class="input required col-xs-7">
												<input name="data[User][username]" class="form-control" type="text" id="UserEmail" value=<?php  echo '"'.$user['User']['email'].'"';?> required="required"><br>
											</div>
						  ...
						  <div class="tab-pane fade col-xs-12" id="logout">
							<p class="text-center">
							<br><br>
							  <a role="button" href="/i/users/logout" class="btn btn-danger"><span class="glyphicon glyphicon-log-out"></span> 离开书摊</a>
							<br><br>
							</p>
						  </div>
			    </div>		
